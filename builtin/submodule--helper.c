...
{
	char *prefixed_path, *config_path;
	...
	config_path = git_pathdup_submodule(update_data->sm_path, "config");
	if (!config_path)
		die(_("could not get submodule directory for '%s'"), update_data->sm_path);
